...
namespace project.NETMVC.Areas.Admin.Controllers
{
    ...
    public class AdminLocationsController : Controller
    {
        ...
        public AdminLocationsController(unisexShopContext context,INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            var pageSize = 10;
            //get customer desc
            var lsLocations = _context.Locations.AsNoTracking().OrderByDescending(x => x.LocationId);
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Conscious")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,Conscious")] Location location)
        {
